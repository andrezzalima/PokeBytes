  ...
  return (
    <div>
      <div className="background-tradeMachine">
        ...
        {showRules && (
          <div style={{border: "10px solid #192653"}} className='rules-content-box bg-white'>
            <img src={pokeballBackground} className='pokeball-background' alt="Pokeball Background" />
